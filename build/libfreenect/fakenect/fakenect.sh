...
if [ `uname` == "Darwin" ];
then
  export DYLD_LIBRARY_PATH="/home/pericao/ros2_ws/install/libfreenect/lib/fakenect/:${DYLD_LIBRARY_PATH}"
else
  export LD_LIBRARY_PATH="/home/pericao/ros2_ws/install/libfreenect/lib/fakenect/:${LD_LIBRARY_PATH}"
fi
